  ...
  Widget build(BuildContext context) {
   ...
   appBar: MainAppbar().appbar(context) ,
      ...
      body:LayoutBuilder(
        ...
        Container(
          width: double.infinity,
          child: Text('مدة تجهيز الطلب : ${mealData.time_of_order} دقيقة',
        ...
        Container(
              ...
              Wrap(children: <Widget>[
                ...
                Card(
                   child: Container(
                     ...
                     width: 92,
                     height: 40,
                     child: Text('${mealQuntity}',style: TextStyle(
                       color: Colors.black,
                       fontSize: 20
                     ),)),
                   shape: RoundedRectangleBorder(
          ...
          RaisedButton(onPressed: (){
            cartData.addItem(mealData.id, mealData.price, mealData.name,mealQuntity);
